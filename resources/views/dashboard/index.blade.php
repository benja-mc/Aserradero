                                ...
                                <div class="me-auto">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="text-primary transaction-caret">
                                            ...
                                            <p class="mb-0 text-primary fs-18 font-w400 mt-14 ml-7">
                                                +0.5%
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="box-body d-flex pb-0">
                                <div class="me-auto">
                                    ...
                                    <p class="fs-16 mb-0 mt-2">
                                        <span class="text-primary">87 </span>left from target
                                    </p>
                                </div>
                        ...
                        <div class="box">
                            <div class="box-body d-flex pb-0">
                                <div class="me-auto">
                                    ...
                                    <p class="fs-14 mb-0 mt-11">
                                        <span class="text-primary">-3% </span>than last month
                                    </p>
                                </div>
                        ...
                        <div class="box">
                            <div class="box-body d-flex pb-0">
                                <div class="me-auto">
                                    ...
                                    <p class="fs-14 mb-0 mt-11">
                                        <span class="text-primary">+0.5% </span>than last month
                                    </p>
                                </div>
                    ...
                    <div class="col-6 col-xl-12 col-md-12 col-sm-12">
                        <div class="box">
                            <div class="box-header">
                                <div class="me-auto">
                                    <h6 class="card-title font-w400 mb-20">
                                        Current Balance
                                    </h6>
                                    ...
                                    <p class="fs-18 mb-0 mt-6">
                                        <span class="text-primary pr-7">+3.2</span>than last
                                        week
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-6 col-xl-12 col-md-12 col-sm-12">
                        <div class="box">
                            <div class="box-body center">
                                <div class="w-100">
                                    <span class="donut-2 w-100"
                                        data-peity='{ "fill": ["#9B8DFF", "#E4EAF8"]}'>228,134</span>
                                </div>
                                <h5 class="fs-20 mb-0 mt-20 font-w500 color-text mt-28">
                                    On Progress<span class="text-primary font-w600 pl-8">50%
                                    </span>
                                </h5>
                                <h5 class="fs-22 mt-18 mb-10 font-wb">
                                    Workload Dashboard For CMS Website
                                </h5>
                                <p class="fs-18 mt-18">
                                ...
                                <div class="content-item mb-wrap">
                                    ...
                                    <div class="right bg-orange">
                                        <div class="content-box w-100">
                                            <h5 class="font-wb text-white fs-20">
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="box box-carousel">
                                    ...
                                    <div class="card-center">
                                        ...
                                        <div class="progress skill-progress mb-23" style="height: 7px; width: 80%">
                                            <div class="progress-bar bg-primary progress-animated"
                                                style="width: 52%; height: 7px" role="progressbar"></div>
                                        </div>
                                        <div class="sm-f-wrap d-flex justify-content-between">
                                            <ul class="user-list">
                                                <li>
                                                    <img src="dashboard/images/avatar/user-1.png" alt="user" />
                                                </li>
                                                <li>
                                                    <img src="dashboard/images/avatar/user-2.png" alt="user" />
                                                </li>
                                                <li>
                                                    <img src="dashboard/images/avatar/user-3.png" alt="user" />
                                                </li>
                                                <li>
                                                    <img src="dashboard/images/avatar/user-4.png" alt="user" />
                                                </li>
                                                <li>
                                                    <img src="dashboard/images/avatar/user-5.png" alt="user" />
                                                </li>
                                            </ul>
                                ...
                                <div class="box box-carousel">
                                    ...
                                    <div class="card-center">
                                        ...
                                        <div class="progress skill-progress mb-23" style="height: 7px; width: 80%">
                                            <div class="progress-bar bg-primary progress-animated"
                                                style="width: 67%; height: 7px" role="progressbar"></div>
                                        </div>
                                        <div class="sm-f-wrap d-flex justify-content-between">
                                            <ul class="user-list">
                                                <li>
                                ...
                                <div class="box box-carousel">
                                    ...
                                    <div class="card-center">
                                        ...
                                        <div class="progress skill-progress mb-23" style="height: 7px; width: 80%">
                                            <div class="progress-bar bg-primary progress-animated"
                                                style="width: 78%; height: 7px" role="progressbar"></div>
                                        </div>
                                        <div class="sm-f-wrap d-flex justify-content-between">
                                            <ul class="user-list">
                                                <li>
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-green">G</h5>
                                            <a class="h5 t-title" href="project-details.html">Brand logo
                                                design</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                    ...
                                    <div class="card-center">
                                        ...
                                        <div class="progress skill-progress mb-23" style="height: 7px; width: 80%">
                                            <div class="progress-bar bg-primary progress-animated"
                                                style="width: 68%; height: 7px" role="progressbar"></div>
                                        </div>
                                        <div class="sm-f-wrap d-flex justify-content-between">
                                            <ul class="user-list">
                                                <li>
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-blue">G</h5>
                                            <a class="h5 t-title" href="project-details.html">New Landing
                                                Design</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-orange">G</h5>
                                            <a class="h5 t-title" href="project-details.html">Skote Dashboard
                                                UI</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                        ...
                        <div class="row">
                            <div class="col-6 col-xl-12 w-sm-100 mb-0">
                                <ul class="box-list mt-26 pr-67">
                                    <li>
                                        <span class="bg-blue square"></span>Web Design<span>25%</span>
                                    </li>
                                    <li>
                                        <span class="bg-success square"></span>UX/UI Design<span>18%</span>
                                    </li>
                                    <li>
                                        <span class="bg-warning square"></span>Graphics
                                        Design<span>17%</span>
                                    </li>
                                    <li>
                                        <span class="bg-blue square"></span>Motion Design<span>12.50%</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span class="bg-warning square"></span>Others<span>12.50%</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-6 col-xl-12 w-sm-100 mb-0">
                                <div class="canvas-container">
                                    ...
                                    <div class="chart-data">
                                        <div data-percent="25" data-color="#3C21F7" data-label="Web Design">
                                        </div>
                                        <div data-percent="18" data-color="#00BC8B" data-label="UX/UI Design">
                                        </div>
                                        <div data-percent="17" data-color="#FFB800" data-label="Graphics Design">
                                        </div>
                                        <div data-percent="12.5" data-color="#00ECCC" data-label="Motion Design">
                                        </div>
                        ...
                        <ul class="message mb-2">
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="dashboard/images/avatar/message-01.png" class="rounded-circle user_img"
                                            alt="" />
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont border-pink">
                                        <img src="dashboard/images/avatar/message-02.png" class="rounded-circle user_img"
                                            alt="" />
                                    </div>
                                    <div class="user_info">
                                        <a class="h6" href="message.html">Jessica Elliot</a>
                                        <p class="fs-14 mb-0">
                                            Do you need like the Color, typography and spacing?
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont border-green">
                                        <img src="dashboard/images/avatar/message-03.png" class="rounded-circle user_img"
                                            alt="" />
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dlab-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont border-blue">
                                        <img src="dashboard/images/avatar/message-04.png" class="rounded-circle user_img"
                                            alt="" />
                                    </div>
                                    <div class="user_info">
