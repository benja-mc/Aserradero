...
@section('main-menu')
    <div class="main-content client list">
                ...
                <div class="box">
                    <div class="box-body d-flex justify-content-between pt-0 pb-0">
                        ...
                        <div class="list-action">
                            ...
                            <a href="#" class="add" data-bs-toggle="modal" data-bs-target="#add_client">Add
                                Client<i class="fas fa-plus-circle"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box client">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#delete_client"><i class="bx bx-trash"></i> Delete</a>
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Tom Schneider</h5>
                        </a>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#delete_client"><i class="bx bx-trash"></i> Delete</a>
                            <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                data-bs-target="#edit_client"><i class="bx bx-edit mr-5"></i>Edit</a>
                        </div>
                    </div>
                    <div class="box-body pt-5 pb-0">
                        <div class="img-box">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Danielle Meyer</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Roy Carpenter</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Andreea Wade</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Brandon Collins</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="client-details.html">
                            <h5 class="mt-17">Kathy Andrews</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="">
                            <h5 class="mt-17">Bobby Mendez</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
            ...
            <div class="col-3 col-md-6 col-sm-12 mb-25">
                <div class="box client">
                    ...
                    <div class="box-body pt-5 pb-0">
                        ...
                        <a href="">
                            <h5 class="mt-17">Doris Sanders</h5>
                        </a>
                        <p class="fs-14 font-w400 font-main">Founder at <span
                                class="text-clo-primary font-w500 pl-4">Company Name</span></p>
                        <ul class="info">
        ...
        <div id="edit_client" class="modal custom-modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
